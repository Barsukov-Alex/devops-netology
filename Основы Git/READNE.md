# Домашнее задание к занятию «Основы Git» Барсуков А.А
...
1. Создан проект [devops-netology](https://gitlab.com/mozdoksity2/devops-netology) в GitLab
...
<img src = "img/hw_2_3.jpg" width = 100%>

4. Создан аннотированный тег `v0.1` с комментарием

<img src = "img/hw_2_4.jpg" width = 100%>

5. Выполнена публикация тегов на GitHub и GitLab
